...
def main():
    ...
    for i in range(args.num_trials):
        ...
        #
        name = "knapsack_ppo_masking_seed-{}_checkpoint-{}".format(str(args.seed), str(args.items))
    ...
    with open('results/knapsack_ppo_masking_seeded_results-{}.pkl'.format(str(args.items)), 'wb') as f:
        pickle.dump(data, f)
