...
from train_ga_knapsack_amask import final_evaluation
...
def main():
    ...
    agent = Agent()
    agent.load("trained_agents/knapsack_ga_masking_seed-{}_checkpoint-{}.json".format(args.seed, str(args.items)))
